...
container.innerHTML = list.map((ch, i) =>   <div class="channel-box" onclick="playChannel('${ch.url}')">   <img src="${logos}" alt="${ch.title}">   <h3>${ch.title}</h3>   <div id="timer-${i}" class="countdown">Loading...</div>   </div>  ).join("");
}
